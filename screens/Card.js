...
import { ingredients } from '../fakedata/fakeData';
...
const Card = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Image
        source={route.params.item.backgroundImage}
      ...
      <View style={styles.cardView}>
        <ScrollView style={{ flex: 1 }}>
          ...
          >
            {route.params.item.extendedTitle}
          </Text>
          ...
          >
            ...
            >
              {route.params.item.calories} calories
            </Text>
            <View style={styles.durationView}>
              ...
              >
                {route.params.item.duration} min
              </Text>
            </View>
          </View>
          ...
          >
            ...
            >
              ...
              <TouchableOpacity
                ...
                style={{ ...styles.quantityTouchableOpacity, marginLeft: 14 }}
              >
                <Text
                  style={{
                    fontSize: 18,
            ...
            <TouchableOpacity
              onPress={() =>
                Alert.alert(
                  'Successful',
                  'Order received, it may take between 10-30 minutes arriving to you.'
                )
              }
              style={{
            ...
            >
              ...
              >
                Order Now ${Math.floor(route.params.item.price * orderQuantity)}
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
